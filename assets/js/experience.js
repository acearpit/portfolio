...
const exp = [
  ...
  },
  {
    ...
    cardImage: "assets/images/experience-page/vkarma.png",
    place: "VKarma Inc.",
    time: "(May, 2020 - June, 2020)",
    desp: "<li>Tasked with developing the website for the Company in limited time frame.</li><li>Developed several web pages embedded with smooth animations.</li><li>Attended SCRUM meetings and worked with a team of experienced developers.</li><li>Tech Stack : HTML, CSS, JAVASCRIPT.</li>",
  },
];
